...
function MenuItem({ link, text, image }) {
  ...
  // 🟦 GSAP marquee timeline (paused by default)
  const marqueeTimeline = React.useRef(null);

  React.useEffect(() => {
    marqueeTimeline.current = gsap.timeline({ repeat: -1, paused: true })
  ...
  const handleMouseLeave = ev => {
    ...
    marqueeTimeline.current.pause().progress(0);
  };
